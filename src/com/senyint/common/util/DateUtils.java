...
public class DateUtils {
	...
	public static SimpleDateFormat FORMAT_yyyyMMdd_HHmmss = new SimpleDateFormat("yyyyMMdd HH:mm:ss");
	...
	public static Date getFinallyDate(Date date) {
		String temp = FORMAT_yyyyMMdd.format(date);
		temp += " 23:59:59";

		try {
			return FORMAT_yyyyMMdd_HHmmss.parse(temp);
	 ...
	 * @return
	 */
	public static Date nDaysAfterDate(Date date, int n) {
		Calendar c = getCalendar();
		c.setTime(date);
	...
	public static String format(String dateStr, SimpleDateFormat orgFormat, SimpleDateFormat tarFormat) {
		return tarFormat.format(strToDate(dateStr, orgFormat));
	}
}
